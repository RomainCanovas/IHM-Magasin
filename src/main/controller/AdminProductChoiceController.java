	...
	void doOperation(List<Product> products) {
		...
		if (this.button.getText().equals(this.changeOriginalPrice.getText()))
			for (Product product : products)
				product.setPrice(Integer.parseInt(this.textField.getText()));


		if (this.button.getText().equals(this.salesCurrent.getText()))
			for (Product product : products)
				product.setCurrentPrice(product.getCurrentPrice() * Integer.parseInt(this.textField.getText()) / 100);


		if (this.button.getText().equals(this.salesOriginal.getText()))
			for (Product product : products)
				product.setCurrentPrice(product.getPrice() * Integer.parseInt(this.textField.getText()) / 100);
